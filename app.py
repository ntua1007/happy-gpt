...
actions = ['叼著魚走了出來，跟你說午安。', '正在偷偷看著你。', '在等你給他吃高級鮭魚罐頭。', '正在籌辦一場貓咪演唱會。', '慵懶地在屋頂上睡覺。','與其他貓咪一起打瞌睡。', '正摩擦著你的腿討摸摸。', '玩耍時不小心撞到牆壁，尷尬地跑開。', '在房間裡找尋一個舒適的角落休息。', '正在追逐一隻蝴蝶。', '跳上高處眺望著夜景。', '正在學習新的抓癢技巧。', '輕輕地舔嘴巴清潔毛髮。', '在花園裡追逐蝴蝶。', '正在曬日光浴。', '躺在窗台上觀察外面的鳥兒。',  '正在玩廢紙球。', '正在挖掘地毯下的秘密。', '正在思考宇宙的奧秘。', '在玩具老鼠前舞動尾巴。', '正在與貓友進行友誼戰。', '在陽台上耍廢。', '正在趴在鋼琴上嘗試彈出一首貓曲。', '悄悄地爬上樹頂。', '趴在窗戶旁觀察松鼠。', '正在捕捉空氣中的灰塵。', '正在幫另一隻貓咪洗澡。', '在藝術品旁邊擺出優雅的姿勢。', '滾來滾去，顆一隻毛球。', '正在學習玩逗貓棒的技巧。', '在紙箱裡窩著，做白日夢。', '坐在窗戶旁邊與白雲一起午睡。', '正在玩2048。', '正在玩俄羅斯方塊。', '打破了花瓶。', '跳進了貓咪隧道裡探險。', '正在訓練自己的狩獵技巧。', '躺在你的懷裡踏踏。', '正在挑戰POPCAT世界紀錄。', '正在搖屁屁。', '趴在暖爐旁邊感受溫暖。', '在房間四處遊蕩，尋找新玩具。', '在電視機前坐著，好奇地看著新聞。', '踩著鋼琴鍵盤，彈奏出一段奇妙的旋律。', '在沙灘上挖了洞，冒出貓頭嚇人。', '在玩蓮蓬頭，搞得全身溼答答。', '正蹲在花盆旁邊觀察植物。', '跳進了枕頭山裡面，和無形的敵人進行戰鬥。', '正走在狹窄的欄杆上，學習平衡技巧。', '躲在馬桶裡冥想。', '在當沙發馬鈴薯。', '正在思考貓生。', '在貓抓板上做出華麗的翻滾動作。', '正呼呼大睡，很chill。', '在床上追逐逗貓棒，玩得不亦樂乎。', '正在洗腳腳。', '躺在窗台上，看著日落。', '在廚房裡四處尋找美食的香氣。', '坐在水窪前，好奇地盯著自己的倒影。', '在游泳池裡玩水。']
